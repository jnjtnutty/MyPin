...
following the logic in [references/identify-optimal-xml-candidate.md](migrate-xml-views-to-jetpack-compose/references/identify-optimal-xml-candidate.md).

### Step 2: Analyze the project and layout

Analyze the identified XML View's structure, hierarchy, and implementation
details.
Use [references/analysis-of-the-project-and-layout.md](migrate-xml-views-to-jetpack-compose/references/analysis-of-the-project-and-layout.md) to
...
[Setup Compose Dependencies and Compiler](migrate-xml-views-to-jetpack-compose/references/android/develop/ui/compose/setup-compose-dependencies-and-compiler.md).
...
[Material 3 migration guidelines](migrate-xml-views-to-jetpack-compose/references/android/develop/ui/compose/designsystems/migrate-xml-theme-to-compose.md).
...
[references/xml-layout-migration.md](migrate-xml-views-to-jetpack-compose/references/xml-layout-migration.md) and the image from Step 4.
...
- To add Compose in Views, use [Compose in Views](migrate-xml-views-to-jetpack-compose/references/android/develop/ui/compose/migrate/interoperability-apis/compose-in-views.md).
- To add Views in Compose, use [Views in Compose](migrate-xml-views-to-jetpack-compose/references/android/develop/ui/compose/migrate/interoperability-apis/views-in-compose.md).
